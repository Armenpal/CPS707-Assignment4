...
public class BackEnd {
	 ...
	 * @param double credit
	 */
	public static void dailyTransactionWriter(String type, String userName, String accType, double credit) throws IOException {
		File file = new File("C:/Users/Armen/Desktop/CPS707/test-files/daily-transactions.txt");
	...
	public static void updateTicketFile(ArrayList<Ticket> ticketsArray, String seller, String transactionFile, String userFile) {
		...
		try {
			PrintWriter writer = new PrintWriter("C:/Users/Armen/Desktop/CPS707/test-files/" + transactionFile);
			writer.close();
			
			
			File file = new File("C:/Users/Armen/Desktop/CPS707/test-files/newTicket.txt");
			FileWriter fr = new FileWriter(file, true);
			BufferedWriter br = new BufferedWriter(fr);
	 ...
	 * @param String userFile
	 */
	public static void updateUserFile(ArrayList<User> userArray, String user, String transactionFile, String userFile) {
		
		try {
			PrintWriter writer = new PrintWriter("C:/Users/Armen/Desktop/CPS707/test-files/newUserFile.txt");
			writer.close();
			
			File file = new File("C:/Users/Armen/Desktop/CPS707/test-files/newUserFile.txt");
			FileWriter fr = new FileWriter(file, true);
			BufferedWriter br = new BufferedWriter(fr);
